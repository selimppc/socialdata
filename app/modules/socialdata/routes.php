...
Route::group(['modules' => 'Socialdata', 'namespace' => 'App\Modules\Socialdata\Controllers'], function() {
...
Route::group(['middleware' => 'auth', 'modules' => 'Socialdata', 'namespace' => 'App\Modules\Socialdata\Controllers'], function() {
