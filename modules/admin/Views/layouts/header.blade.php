    ...
    <div class="headerbar">
                ...
                <li class="header-nav-brand" >
                    <div class="brand-holder">
                        <a href="../../html/dashboards/dashboard.html">
                            <span class="text-lg text-bold text-primary">{{isset(Auth::user()->username)?ucfirst(Auth::user()->username):''}}</span>
                        </a>
                    </div>
                </li>
                <li>
        ...
        <div class="headerbar-right">
            <ul class="header-nav header-nav-options">
                <li>
                    <!-- Search form -->
                    {!! Form::open(['route'=>'main-search','method'=>'get','class'=>'navbar-search','role'=>'search']) !!}
                    {{--<form action="{{ route('main-search') }}" method="get" class="navbar-search" role="search">--}}
                        <div class="form-group">
                            {!! Form::text('headerSearch',null,['class'=>'form-control','placeholder'=>'Enter your keyword']) !!}
            ...
            <ul class="header-nav header-nav-profile">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animation-dock">
                        ...
                        <li><a href="{{Route('user-logout')}}"><i class="fa fa-fw fa-power-off text-danger"></i> Logout</a></li>
                    </ul><!--end .dropdown-menu -->
                </li><!--end .dropdown -->
