...
<div class="footer-form-margin-btn">
    ...
    <a href="{{ route('index-company-social-account',$company_id) }}" class=" btn btn-default" data-placement="top" data-content="click close button for close this entry form">Close</a>
</div>