...
class CreateAllTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::unprepared(file_get_contents("modules/socialdata/database/sql_dump/company.sql"));
        DB::unprepared(file_get_contents("modules/socialdata/database/sql_dump/sm_type.sql"));
        DB::unprepared(file_get_contents("modules/socialdata/database/sql_dump/company_social_account.sql"));
