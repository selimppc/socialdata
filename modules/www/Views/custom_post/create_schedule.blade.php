...
{{--{!! Form::open(['route'=>['create-schedule']])  !!}--}}
...
{{--        {!! Form::submit('Confirm', ['class' => 'btn btn-primary','data-placement'=>'top']) !!}&nbsp;--}}
        <a href="#" class=" btn btn-default" data-dismiss="modal" aria-label="Close" data-placement="top" data-content="click close button for close this entry form">Close</a>
    </div>
</div>
{{--{!! Form::close() !!}--}}